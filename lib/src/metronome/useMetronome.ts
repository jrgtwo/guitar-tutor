...
import type { MetronomeEvents, MetronomeOptions, TimeSignature } from './types';
...
interface UseMetronomeOptions
  extends Omit<MetronomeOptions, 'bpm' | 'timeSignature' | 'accents' | 'accentEnabled' | 'volume'> {
...
function ensureSharedMetronome(): Metronome | null {
  ...
  // component reading the store stays in lockstep with the audio loop.
