/**
 * TopBar — example app's version of the lib's TopBar, with the Metronome section
 * inserted. The lib's TopBar stays untouched (no metronome there) so consumers can
 * reuse it without bringing in audio dependencies they don't need.
 */
import {
  Button,
  InstrumentSelect,
